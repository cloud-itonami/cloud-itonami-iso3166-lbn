(ns marketentry.store
  "SSoT for the LBN market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems LB" :portal "PPA e-Procurement Platform"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-beneficial-ownership-declaration? true :beneficial-ownership-declared? true
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "LBN" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "PPA e-Procurement Platform"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-beneficial-ownership-declaration? true :beneficial-ownership-declared? true
             :requires-cr? true :cr-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "PPA e-Procurement Platform"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "LBN" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "PPA e-Procurement Platform"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-beneficial-ownership-declaration? true :beneficial-ownership-declared? false
             :requires-cr? true :cr-verified? true
             :drafted? false :submitted? false
             :jurisdiction "LBN" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "PPA e-Procurement Platform"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-beneficial-ownership-declaration? true :beneficial-ownership-declared? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "LBN" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "PPA e-Procurement Platform"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-beneficial-ownership-declaration? beneficial-ownership-declared?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-beneficial-ownership-declaration?) (assoc :engagement/requires-beneficial-ownership-declaration? requires-beneficial-ownership-declaration?)
    (some? beneficial-ownership-declared?)             (assoc :engagement/beneficial-ownership-declared? beneficial-ownership-declared?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-beneficial-ownership-declaration? :engagement/beneficial-ownership-declared?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-beneficial-ownership-declaration? (boolean (:engagement/requires-beneficial-ownership-declaration? m))
     :beneficial-ownership-declared? (boolean (:engagement/beneficial-ownership-declared? m))
